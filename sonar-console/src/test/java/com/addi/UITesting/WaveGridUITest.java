...
class WaveGridUITest extends UITest {
  ...
  void preferredSizeIsCorrect() {
    ...
    assertEquals(new Dimension(700, 350), waveGrid.getPreferredSize());
  }
  ...
  void constructorRejectsZeroFrequency() {
    assertThrows(IllegalArgumentException.class, () -> new WaveGrid(0.0));
  }

  @Test
  void constructorRejectsNegativeFrequency() {
    assertThrows(IllegalArgumentException.class, () -> new WaveGrid(-1.0));
  }

  @Test
  void constructorRejectsNaNFrequency() {
    assertThrows(IllegalArgumentException.class, () -> new WaveGrid(Double.NaN));
  }

  @Test
  void constructorRejectsInfiniteFrequency() {
    assertThrows(IllegalArgumentException.class, () -> new WaveGrid(Double.POSITIVE_INFINITY));
  }
  ...
  void setFrequencyRejectsInvalidFrequency() {
    ...
    assertThrows(IllegalArgumentException.class, () -> waveGrid.setFrequency(-2.0));
  }
